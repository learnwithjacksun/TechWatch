              ...
              <div className="layout line pb-8 my-8 md:my-0 md:min-h-[400px] flex-center">
                  <div className="flex flex-col gap-6 items-center">
                      <div className="text-center">
                          <span className="bg-mid text-sub py-1 px-4 rounded-full text-sm font-semibold">30 days of Tech 🚀</span>
                      ...
                      <div className="flex-center flex-col-reverse md:flex-row gap-4">
                          <Link to="" className="btn bg-light shadow-lg px-8 h-12 w-[250px] md:w-auto rounded-full border border-line">
